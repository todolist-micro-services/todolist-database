...
public enum SqlOperation {
    ...
    RETRIEVE_PROJECT_BY_ID("SELECT * FROM Project WHERE project_id = ?;"),
    ...
    RETRIEVE_USER_PROJECT_BY_NAME("SELECT * FROM Project WHERE creator = ? AND name = ?;"),
    ...
    RETRIEVE_ONE_PROJECT_EVENT("SELECT * FROM Event WHERE event_id = ?;"),
    RETRIEVE_PROJECT_EVENT_BY_NAME("SELECT * FROM Event WHERE name = ? AND PROJECT = ? ORDER BY event_id DESC LIMIT 1;"),
    ...
    RETRIEVE_PROJECT_LIST_BY_NAME("SELECT * FROM List WHERE name = ? AND PROJECT = ? ORDER BY list_id DESC LIMIT 1;"),
    RETRIEVE_LIST_TASK_BY_NAME("SELECT * FROM Task WHERE name = ? AND list = ? ORDER BY task_id DESC LIMIT 1;"),
    ...
    UNLINK_USER_TO_TASK("DELETE FROM UserTask WHERE user_id = ? AND task_id = ?;"),
